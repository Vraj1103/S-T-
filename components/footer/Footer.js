  ...
  return (
    <footer className={`${Styles.footer} container-70`}>
        ...
        <div className="flex-2 md:flex-1">
          <div className="mb-3 flex flex-col">
            ...
            <h4 className="text-lg font-extralight">
              <a href="mailto:venv.developers@gmail.com">venv.developers@gmail.com</a>
            </h4>
          </div>
      ...
      <div className={Styles.copyrightBottom}>
        <h6>
          © {new Date().getFullYear()} Venv. All rights
          reserved.
        </h6>

        <h6 className="flex items-center">
          Crafted with&nbsp;<span className="text-2xl">♥</span>&nbsp;by VenV
          Team.
        </h6>
      </div>
    </footer>
