  ...
  return (
    <Screen>
      <Head>
        ...
        <meta
          name="description"
          content="Contact Information of VenV (Hackathon & Coding Club), PDPU, Dhanbad"
        />
        <meta
          name="keywords"
          content="HTML, CSS, JavaScript, ReactJS, NextJS, TailwindCSS, VenV, Contact VenV, Hackathon & Coding Club, PDPU, Dhanbad"
        />
      </Head>
        ...
        <div className={`${show ? 'invisible hidden' : 'visible'} z-10`}>
          <div className="mt-28 mb-12 pt-10 pb-8 sm:mt-20 sm:mb-10">
            ...
            <p className="mt-20 w-2/5 text-lg xl:w-3/5 sm:w-3/4 sm:text-base">
              ...
              <span>
                <a className="text-blue" href="mailto:VenV.developers@gmail.com">
                  VenV.developers@gmail.com
                </a>
              </span>
            </p>
          </div>
  ...
  return (
    ...
    >
      ...
      <p className="mt-20 w-3/5 text-lg xl:w-3/5 sm:w-3/4 sm:text-base">
        ...
        <span>
          <a className="text-blue" href="https://blog.VenVPDPU.com/">
            blog
          </a>
        </span>{' '}
        and roam around the{' '}
