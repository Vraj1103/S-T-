  ...
  return (
    <Screen>
      <Head>
        ...
        <meta
          name="description"
          content="VenV or Hackathon and Coding Club is the official club of PDPU that has the motto to instill a coding culture, collaborate, and arrange events relevant to Open Source, Graphics and Game Development, Web Development, App Development, and many other topics."
        />
        <meta
          name="keywords"
          content="HTML, CSS, JavaScript, ReactJS, NextJS, TailwindCSS, VenV, About VenV, Hackathon & Coding Club, PDPU, Dhanbad"
        />
      </Head>
      <section className="container-70 pt-28 md:pt-16 sm:pt-12">
        <div className="hidden">
          <p className="px-6">
            ...
            Hackathon and Coding Club of PDPU. The organization has been
        ...
        <div className="mt-12 mb-6 sm:mt-8 sm:mb-4">
          <BottomGlitter text="About VenV" />
          <div className="mt-6">
            <p className="text-lg">
              Hackathon and Coding Club (VenV) is the official coding and
              development club of PDPU. It was started with an initial
        ...
        <div className="mt-20 mb-6 sm:mt-8 sm:mb-4">
          ...
          <div className="mt-6">
            <p className="text-lg">
              ...
              <a
                className="text-blue"
                href="https://www.hackatron.hnccPDPU.com"
              >
                hackatron.hnccPDPU.com
              </a>
              <br />
              ...
              CodeChef Chapter of PDPU, Dhanbad. See more about our coding
              culture at our official site{' '}
              <a className="text-blue" href="https://www.contest.hnccPDPU.com">
                contest.hnccPDPU.com
              </a>{' '}
            </p>
          </div>
        </div>
