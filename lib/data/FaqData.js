...
const options = [
  {
    ...
    body: (
      <>
        VenV, Hackathon and Coding Club is the Official Coding Club of BIT
  ...
  {
    title: <>Who is the Professor-In-Charge of VenV ?</>,
    body: (
      <>
        The Professor-In-Charge of VenV is Mr. Dinesh Kumar Prabhakar Sir from
        the Dept. of Information Technology, PDPU.
      </>
    ),
  },
  {
    title: <>Where does VenV operate from ?</>,
    body: (
      <>
        In college, VenV operates from IT Building, PDPU, Dhanbad,
        Jharkhand-828123, now it is in operation via remote only
      </>
    ),
  },
  {
    title: <>What qualities are required at VenV ?</>,
    body: (
      <>
        To join VenV you have to:-
        <ul className="pl-8">
          <li>
          ...
          <li>
            Be patient. You have to prove your willingness to join VenV. We will
        ...
        <ul>
          ...
          <li>
            Learn digital art from the guidance of current VenV members and
  ...
  {
    title: <>What are some of the domains of VenV ?</>,
    body: (
      <>
        The domains of VenV are:-
        <ul>
  ...
  {
    title: <>What tasks do I need to do to land an interview for VenV ?</>,
    body: (
      <>
        Do at least one of the following:-
        <ul>
          <li>
            Get in touch with a member of VenV and ask him/her to refer you.
          ...
          <li>
            ...
            of VenV). In such a scenario Management has more weightage.
          </li>
          <li>Have any prior experience with Robots or Arduino.</li>
          <li>
            Miscellaneous i.e. Show us any skill that you might think VenV might
            be interested in.
          </li>
        </ul>
  ...
  {
    title: (
      <>I am not from a CSE/IT Branch. Is VenV the right choice for me ?</>
    ),
    body: (
      <>
  ...
  },
  {
    ...
    body: (
      <>
        ...
        etc. , VenV got you covered.
        <br />
        There are some organizations/clubs you can be in along with VenV are:-
        <ul>
          <li>Arts Club</li>
          <li>Sports Club</li>
          <li>Prayaas India</li>
  ...
  },
  {
    ...
    body: (
      <>
        ...
        or follow{' '}
        <a href="https://learn.VenVPDPU.com" target="_blank" rel="noreferrer">
          VenV Learn.
        </a>
      </>
    ),
  ...
  {
    title: <>Can a Non-Bitian become a member of VenV ?</>,
    body: (
      <>
        VenV is working towards making the community diverse and strong. We are
        going to come up with this idea very soon. Right now we are working
        towards the structure of VenV when Non-Bitian can join.
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    body: (
      <>
        ...
        <br />
        In VenV we use Unity as it is good for beginners and small developers.
  ...
  {
    title: <>I don’t have a laptop. I am eligible to join VenV ?</>,
    body: (
      <>
        ...
        Yes, you need a laptop to survive in VenV or else you will not be able
        to take the benefit of the community that VenV offers.
      </>
    ),
  },
  {
  ...
  {
    title: <>I want someone to mentor me. Can VenV help me ?</>,
    body: (
      <>
        <Link href="/teams">
          <a>VenV Team Page</a>
  ...
  {
    title: <>What are some of the achievements of VenV ?</>,
    body: (
      <>
        <ul>
          <li>
          ...
          <li>
            A team from VenV won the 1st prize in COVIDTHON organized by Govt.
            of Jharkhand
          </li>
        </ul>
  ...
  {
    title: <>What is Linux ? Why do VenV members suggest Linux ?</>,
    body: (
      <>
        ...
        <br />
        <br />
        <strong>Long Answer</strong>:- VenV Members will always suggest you go
        ...
        <a
          href="https://blog.VenVPDPU.com/2020-07-16-LinuxExp-blog/"
          target="_blank"
          rel="noreferrer"
        >
          Developer Docs
  ...
  },
  {
    title: (
      <>
        What are some of the projects deployed by VenV and can be seen by users
        ?
      </>
    ),
    body: (
      <>
        ...
        <ul>
          <li>
            <Link href="/">
              <a rel="noreferrer">VenV Club Site</a>
            </Link>
          </li>
          <li>
            <a
              href="https://contest.VenVPDPU.com"
              target="_blank"
              rel="noreferrer"
            >
              VenV Contest Page
          ...
          <li>
            <a
              href="https://hackatron19.VenVPDPU.com"
              target="_blank"
              rel="noreferrer"
            >
        ...
        <ul>
          <li>
            <a
              href="https://play.google.com/store/apps/details?id=com.VenV.APlane"
              target="_blank"
              rel="noreferrer"
            >
        ...
        <br />
        Apart from this VenV has made a lot of Projects. The projects above
        mentioned were robust and scalable enough to be used by the public.
      </>
    ),
  },
  {
    title: <>What are the social handles of VenV ?</>,
    body: (
      <>
        <a
          href="https://www.facebook.com/VenVPDPU/"
          target="_blank"
          rel="noreferrer"
        >
          Facebook
        ...
        <br />
        <a
          href="https://www.linkedin.com/company/VenVPDPU/"
          target="_blank"
          rel="noreferrer"
        >
          LinkedIn
        ...
        <br />
        <a
          href="https://www.instagram.com/VenVPDPU/"
          target="_blank"
          rel="noreferrer"
        >
          Instagram
        ...
        <br />
        <a href="https://github.com/VenVPDPU" target="_blank" rel="noreferrer">
          GitHub
        </a>
      </>
    ),
  ...
  {
    title: <>We are an organization and we want to collab with VenV.</>,
    body: (
      <>
        Email us at <a href="mailto:VenVdevelopers@gmail.com">VenVdevelopers@gmail.com</a>{' '}
